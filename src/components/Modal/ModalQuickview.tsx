                        ...
                        <div className="right w-full px-4">
                            ...
                            <div className="product-infor px-4">
                                ...
                                <div className="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
                                    <div className="product-price heading5"><span className="currency-symbol">৳</span>{selectedProduct?.price}.00</div>
                                    <div className='w-px h-4 bg-line'></div>
                                    <div className="product-origin-price font-normal text-secondary2"><del><span className="currency-symbol">৳</span>{selectedProduct?.originPrice}.00</del></div>

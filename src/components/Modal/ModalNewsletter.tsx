                    ...
                    <div className="main-content flex rounded-[20px] overflow-hidden w-full">
                        ...
                        <div className="right lg:w-1/2 sm:w-3/5 w-full bg-white sm:pt-10 sm:pl-10 max-sm:p-6 relative">
                            ...
                            <div className="list flex flex-col gap-5 overflow-x-auto sm:pr-6">
                                {productData.slice(11, 16).map((item:any, index) => (
                                    <>
                                        <div
                                            ...
                                            >
                                                ...
                                                <div className=''>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-2">
                                                        <div className="product-price text-title"><span className="currency-symbol">৳</span>{item.price}.00</div>
                                                        <div className="product-origin-price text-title text-secondary2">
                                                            <del><span className="currency-symbol">৳</span>{item.originPrice}.00</del>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
